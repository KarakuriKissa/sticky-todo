...
const ja: Dict = {
  ...
  // ── Advanced tab ──────────────────────────────────────────────────────────
  // 大分類の見出し。各項目の詳しい説明は行の title="" ツールチップへ退避。
  'adv.sectionDisplay': '表示',
  'adv.sectionBehavior': '動作',
  'adv.sectionStartup': '起動',
  'adv.sectionData': 'データ',
  'adv.notifShortLabel': '通知',
  'adv.browserShortLabel': 'ブラウザ',
  'adv.sampleShortLabel': 'サンプル',
  'adv.backupShortLabel': 'バックアップ',
...
const en: Dict = {
  ...
  'adv.sectionDisplay': 'Display',
  'adv.sectionBehavior': 'Behavior',
  'adv.sectionStartup': 'Startup',
  'adv.sectionData': 'Data',
  'adv.notifShortLabel': 'Alerts',
  'adv.browserShortLabel': 'Browser',
  'adv.sampleShortLabel': 'Samples',
  'adv.backupShortLabel': 'Backup',
  ...
  'help.about.prefix': 'PetaMemo is a ',
